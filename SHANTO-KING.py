...
ugen=[]
ugen=[]
header_grup = {"user-agent": "Mozilla/5.0 (Linux; Android 11; SM-A725F Build/RP1A.200720.012; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/116.0.0.0 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/429.0.0.27.114"}
...
for xd in range(10000):
        aa='Mozilla/5.0 (Linux; Android 11; SM-A725F Build/RP1A.200720.012; wv)'
...
for agent in range(10000):
        aa='Mozilla/5.0 (Linux; Android 12; 22127PC95I Build/SP1A.210812.016; wv)'
        b=random.choice(['6','7','8','9','10','11','12'])
